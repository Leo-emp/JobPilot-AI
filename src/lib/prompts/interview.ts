...
NEXT QUESTION TO ASK (USE THIS — CRITICAL FOR SPEED):
${payload.nextQuestion}
INSTRUCTIONS: For exchange 1, use "Tell me about yourself" as always. For exchange 2+, use the question above. You MUST still add a 1-sentence warm reaction to the candidate's answer before asking it. Using this pre-planned question means you only need to write a brief reaction — keep your response short and fast.` : ""}
