...
<tr><td style="padding: 0 52px;">
  <p style="font-family: ${FONT}; font-size: 14.5px; color: #c4c4d8; margin: 0; line-height: 1.8; letter-spacing: -0.1px;">You still have access to every feature &mdash; your saved resumes, cover letters, and application history are all still here. The only change is your AI usage limit.</p>
</td></tr>
