/* ============================================================
   CANCELLATION EMAIL - Sent when a user's subscription ends
   ============================================================
   # Matches the premium dark/space theme of the welcome email.
   # Friendly tone — no guilt trip, just a helpful nudge.
   ============================================================ */
...
export function buildCancellationEmail(firstName: string): string {
  return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<tr><td style="padding: 52px 52px 0 52px;">
  ...
  <h1 style="font-family: ${FONT_DISPLAY}; font-size: 28px; font-weight: 700; color: #ffffff; margin: 0 0 10px 0; line-height: 1.15; letter-spacing: -0.8px;">Your Pro plan has ended.</h1>
  <p style="font-family: ${FONT}; font-size: 16px; font-weight: 500; color: #c4c4d8; margin: 0; line-height: 1.5; letter-spacing: -0.2px;">Your account has been switched back to the free plan.</p>
</td></tr>
...
<tr><td style="padding: 0 52px;">
  <p style="font-family: ${FONT}; font-size: 14.5px; color: #c4c4d8; margin: 0; line-height: 1.8; letter-spacing: -0.1px;">You still have full access to your free-tier features &mdash; your saved resumes, cover letters, and application history are all still here.</p>
</td></tr>
...
<tr><td align="center" style="padding: 40px 52px 0 52px;">
  ...
  <tr><td style="border-radius: 12px; background: linear-gradient(135deg, #4f46e5, #7c3aed); text-align: center;">
    <a href="https://jobpilotai.co/dashboard/settings" style="display: inline-block; width: 100%; padding: 16px 0; font-family: ${FONT}; font-size: 14px; font-weight: 600; color: #ffffff; text-decoration: none; letter-spacing: 0.2px; box-sizing: border-box;">Reactivate Pro &rarr;</a>
  </td></tr>
  </table>
</td></tr>
