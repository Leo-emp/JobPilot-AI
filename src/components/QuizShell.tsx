  ...
  if (phase === "results") {
    return (
      <div className="max-w-4xl mx-auto">
        ...
        {/* # Legal disclaimer — always visible below results */}
        {result && !loading && !streaming && (
          <p className="mt-8 text-xs text-text-muted/60 leading-relaxed text-center max-w-2xl mx-auto">
            This assessment is generated by AI for informational and self-reflection purposes only. It does not constitute professional career counselling, financial advice, psychological assessment, or a substitute for working with a qualified professional. JobPilot AI makes no guarantees about the accuracy or suitability of these results. Your career decisions and their outcomes are your own responsibility.
          </p>
        )}
