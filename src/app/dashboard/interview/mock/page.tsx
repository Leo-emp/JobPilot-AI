...
export default function MockInterviewPage() {
  ...
  const startListening = useCallback(async () => {
    ...
    /* Fully clean up any existing recognition session.
       Null the ref FIRST so the old onend handler won't auto-restart. */
    ...
    <div>
      ...
      {loadingResults ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          {/* # Mascot thinking — Sarah is analyzing the interview */}
          <Image src="/mascot/mascot-thinking.png" alt="Analyzing..." width={64} height={64} className="mb-3" />
          <svg className="animate-spin h-5 w-5 text-brand-indigo mb-3" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" /></svg>
