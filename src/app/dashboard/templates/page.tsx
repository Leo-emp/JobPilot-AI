...
function buildCompact(d: ResumeData): string {
  const css = `
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    h2 { font-size:10px; font-weight:800; text-transform:uppercase; letter-spacing:1.5px; color:#fff; background:#374151; padding:6px 10px; margin-bottom:5px; display:inline-block; text-align:center; line-height:1; }
