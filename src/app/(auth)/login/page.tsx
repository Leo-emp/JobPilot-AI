/* ============================================================
   ...
   2. LinkedIn OAuth — one-click sign in
   3. Email + password — traditional login form
   ============================================================ */
...
export default function LoginPage() {
  ...
  /* Handle OAuth sign in (Google or LinkedIn) */
    ...
    <div className="w-full max-w-md">
      <div className="glass-card p-8 sm:p-10">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-sm text-text-muted">or sign in with email</span>
          <div className="flex-1 h-px bg-card-border" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <Link href="/forgot-password" className="text-xs text-brand-light hover:text-white transition-colors">
                Forgot password?
              </Link>
            </div>
            <input
