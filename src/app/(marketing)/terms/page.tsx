      ...
      <div className="space-y-10 text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <li>All payments are non-refundable unless required by applicable law. You may cancel your subscription at any time and retain access until the end of your current billing period. Our free tier provides full access to every feature, allowing you to evaluate the platform before subscribing. For billing inquiries, email <a href="mailto:support@jobpilotai.co" className="text-brand-light hover:text-white transition-colors">support@jobpilotai.co</a>.</li>
