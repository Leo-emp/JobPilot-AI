...
export const metadata = {
  title: "Cookie Policy — JP Arc",
  description: "JP Arc cookie policy. We only use essential authentication cookies — no tracking, no ads, no third-party analytics cookies.",
  alternates: { canonical: "https://jobpilotai.co/cookies" },
};
